...
const SCREENS = [
  {
    url: Assets.Zenithrequestfeedback, caption:  "Teachers can add recorded classroom sessions (observations) and request feedback",
  },
  {
    url: Assets.Zenithpastfeedback,
    caption: "Teachers can view completed observations with feedback from their Principal or Assistant Principal",

  },
  {
    url: Assets.Zenithautogeneratedfeedback,
