...
const Footer = ({ reversed = false, isDetail = false, onClick, description }: {description?: string, reversed?: boolean, isDetail?: boolean, onClick?: () => void }) => (
  <footer className={cn("mt-24 pt-12 border-t border-dashed border-[#B1B1B8] flex flex-col lg:flex-row lg:items-end", reversed && "md:flex-row-reverse")}>
    ...
    <div className="flex justify-start my-4 lg:my-0 lg:justify-center ">
      <img
    ...
    {!isDetail && <div className={cn("my-10 flex flex-wrap items-center gap-4 flex-1", reversed ? "justify-center md:justify-end" : "justify-center md:justify-start")}>
